...
import { Upload, Search, X, Trash, Eye, Plus } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      {loading ? (
          ...
          {designs.map((design) => (
            <div key={design.id} className="bg-white rounded-lg shadow-sm overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-500 mt-1 line-clamp-2">{design.description || "No description"}</p>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-12 text-center">
          ...
          <p className="text-sm text-gray-500 mb-6">Upload your first design to start creating products</p>
          <Link
            to="/dashboard/designs/new"
            className="inline-flex items-center px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors"
          >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            <div className="p-4 border-b flex justify-between items-center">
              <h3 className="text-lg font-medium text-gray-900">{selectedDesign.name}</h3>
              <button 
            ...
            <div className="overflow-auto p-6 flex-1">
              <div className="bg-gray-100 rounded-lg p-4 flex justify-center">
                <img 
                  src={selectedDesign.designUrl || "https://via.placeholder.com/600"} 
              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">{new Date(selectedDesign.createdAt).toLocaleDateString()}</p>
                  </div>
                </div>
              </div>
            </div>
